...
def baca_stok(nama_file):
    ...
    with open(nama_file,"r",encoding="utf-8") as file:
        for baris in file:
            ...
            stok_dict[kode_barang] = {"nama barang": nama_barang, "stok": int(stok)}
        return stok_dict
...
def tampilkan_semua(stok_dict):
    ...
    {'Kode Barang': <10} artinya nim rata kiri dengan lebar kolom 12 karakter
    {'Stok: >5} artinya nilai rata kanan dengan lebar kolom 5 karakter
