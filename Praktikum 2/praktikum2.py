...
#buka_data = baca_nama(nama_file) #memanggil fungsi load data dan menyimpan dalam variabel
...
# ================================================================================
# Praktikum 2: Konsep ADT dan File Handling (STUDI KASUS)
# Latihan 4: Membuat Fungsi Menyimpan Data dalam File
# ================================================================================
...
def main():
    ...
    buka_data = baca_nama(nama_file) #fs.1 fungsi load data

    while True:
        print("===MENU DATA MAHASISWA===")
        print("1. Tampilkan Data Mahasiwa")
